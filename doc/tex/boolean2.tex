...
\mbox{}\verb@@\hbox{$\langle\,$Import the module\nobreak\ ({\footnotesize \NWtarget{nuweb5c}{5c}\label{scrap9}
 }\mbox{}\verb@boolean2@ ) {\footnotesize \NWlink{nuweb17g}{17g}}$\,\rangle$}\verb@@\\
...
\protect\makebox[0ex][r]{\NWtarget{nuweb10c}{\rule{0ex}{0ex}}\hspace{1em}}$\langle\,$Computation invariant supercells\nobreak\ {\footnotesize 10c}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\protect\makebox[0ex][r]{\NWtarget{nuweb11a}{\rule{0ex}{0ex}}\hspace{1em}}$\langle\,$Invariant subsets of supercells\nobreak\ {\footnotesize 11a}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\mbox{}\verb@@\\
\mbox{}\verb@pivot1 = set(BSupCells1).difference(invSupCells1)@\\
\mbox{}\verb@pivot2 = set(BSupCells2).difference(invSupCells2)@\\
\mbox{}\verb@VIEW(STRUCT([ @\\
...
\protect\makebox[0ex][r]{\NWtarget{nuweb11b}{\rule{0ex}{0ex}}\hspace{1em}}$\langle\,$Covers of divisors computation\nobreak\ {\footnotesize 11b}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@# Covers of divisors computation@\\
\mbox{}\verb@covers1 = minimalCovers(V,pivot1,CV1,CV,setCV)@\\
\mbox{}\verb@covers2 = minimalCovers(V,pivot2,CV2,CV,setCV)  @\\
\mbox{}\verb@VIEW(STRUCT([ @\\
...
\protect\makebox[0ex][r]{\NWtarget{nuweb12a}{\rule{0ex}{0ex}}\hspace{1em}}$\langle\,$Select cells incident on vertices\nobreak\ {\footnotesize 12a}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\protect\makebox[0ex][r]{\NWtarget{nuweb12b}{\rule{0ex}{0ex}}\hspace{1em}}\verb@"lib/py/boolean2.py"@\nobreak\ {\footnotesize 12b }$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\protect\makebox[0ex][r]{\NWtarget{nuweb13a}{\rule{0ex}{0ex}}\hspace{1em}}$\langle\,$Generation of $n$ random points in the unit $d$-disk\nobreak\ {\footnotesize 13a}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\protect\makebox[0ex][r]{\NWtarget{nuweb13b}{\rule{0ex}{0ex}}\hspace{1em}}$\langle\,$Generation of $n$ random points in the standard $d$-cuboid\nobreak\ {\footnotesize 13b}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\protect\makebox[0ex][r]{\NWtarget{nuweb14}{\rule{0ex}{0ex}}\hspace{1em}}$\langle\,$Triangulation of random points\nobreak\ {\footnotesize 14}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\mbox{}\verb@@\hbox{$\langle\,$Import the module\nobreak\ ({\footnotesize \NWtarget{nuweb15c}{15c}\label{scrap28}
 }\mbox{}\verb@lar2psm@ ) {\footnotesize \NWlink{nuweb17g}{17g}}$\,\rangle$}\verb@@\\
\mbox{}\verb@@\hbox{$\langle\,$Import the module\nobreak\ ({\footnotesize \NWtarget{nuweb15d}{15d}\label{scrap29}
 }\mbox{}\verb@myfont@ ) {\footnotesize \NWlink{nuweb17g}{17g}}$\,\rangle$}\verb@@\\
...
\protect\makebox[0ex][r]{\NWtarget{nuweb15e}{\rule{0ex}{0ex}}\hspace{1em}}\verb@"test/py/boolean2/test04.py"@\nobreak\ {\footnotesize 15e }$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@""" test program for the boolean module """@\\
\mbox{}\verb@@\hbox{$\langle\,$Initial import of modules\nobreak\ {\footnotesize \NWlink{nuweb17a}{17a}}$\,\rangle$}\verb@@\\
...
\protect\makebox[0ex][r]{\NWtarget{nuweb16a}{\rule{0ex}{0ex}}\hspace{1em}}\verb@"test/py/boolean2/test03.py"@\nobreak\ {\footnotesize 16a }$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@""" test example with general LAR cells for the boolean module """@\\
\mbox{}\verb@@\hbox{$\langle\,$Initial import of modules\nobreak\ {\footnotesize \NWlink{nuweb17a}{17a}}$\,\rangle$}\verb@@\\
\mbox{}\verb@@\hbox{$\langle\,$Import the module\nobreak\ ({\footnotesize \NWtarget{nuweb16b}{16b}\label{scrap33}
 }\mbox{}\verb@boolean2@ ) {\footnotesize \NWlink{nuweb17g}{17g}}$\,\rangle$}\verb@@\\
...
\protect\makebox[0ex][r]{\NWtarget{nuweb16c}{\rule{0ex}{0ex}}\hspace{1em}}$\langle\,$Visualization of a subset of cells\nobreak\ {\footnotesize 16c}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\protect\makebox[0ex][r]{\NWtarget{nuweb16d}{\rule{0ex}{0ex}}\hspace{1em}}$\langle\,$Visualization of first Boolean step\nobreak\ {\footnotesize 16d}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\footnotesize\addtolength{\baselineskip}{-1ex}
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb15a}{15a}\NWlink{nuweb15e}{e}\NWlink{nuweb16a}{, 16a}.
\end{list}
\end{flushleft}
%------------------------------------------------------------------
...
\protect\makebox[0ex][r]{\NWtarget{nuweb17a}{\rule{0ex}{0ex}}\hspace{1em}}$\langle\,$Initial import of modules\nobreak\ {\footnotesize 17a}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\mbox{}\verb@@\hbox{$\langle\,$Import the module\nobreak\ ({\footnotesize \NWtarget{nuweb17b}{17b}\label{scrap37}
 }\mbox{}\verb@lar2psm@ ) {\footnotesize \NWlink{nuweb17g}{17g}}$\,\rangle$}\verb@@\\
\mbox{}\verb@@\hbox{$\langle\,$Import the module\nobreak\ ({\footnotesize \NWtarget{nuweb17c}{17c}\label{scrap38}
 }\mbox{}\verb@simplexn@ ) {\footnotesize \NWlink{nuweb17g}{17g}}$\,\rangle$}\verb@@\\
\mbox{}\verb@@\hbox{$\langle\,$Import the module\nobreak\ ({\footnotesize \NWtarget{nuweb17d}{17d}\label{scrap39}
 }\mbox{}\verb@larcc@ ) {\footnotesize \NWlink{nuweb17g}{17g}}$\,\rangle$}\verb@@\\
\mbox{}\verb@@\hbox{$\langle\,$Import the module\nobreak\ ({\footnotesize \NWtarget{nuweb17e}{17e}\label{scrap40}
 }\mbox{}\verb@largrid@ ) {\footnotesize \NWlink{nuweb17g}{17g}}$\,\rangle$}\verb@@\\
\mbox{}\verb@@\hbox{$\langle\,$Import the module\nobreak\ ({\footnotesize \NWtarget{nuweb17f}{17f}\label{scrap41}
 }\mbox{}\verb@myfont@ ) {\footnotesize \NWlink{nuweb17g}{17g}}$\,\rangle$}\verb@@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1ex}
\footnotesize\addtolength{\baselineskip}{-1ex}
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb5b}{5b}\NWlink{nuweb12b}{, 12b}\NWlink{nuweb15a}{, 15a}\NWlink{nuweb15e}{e}\NWlink{nuweb16a}{, 16a}.
\end{list}
\end{flushleft}
%------------------------------------------------------------------
...
\protect\makebox[0ex][r]{\NWtarget{nuweb17g}{\rule{0ex}{0ex}}\hspace{1em}}$\langle\,$Import the module\nobreak\ {\footnotesize 17g}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\footnotesize\addtolength{\baselineskip}{-1ex}
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb5b}{5b}\NWlink{nuweb15a}{, 15a}\NWlink{nuweb15e}{e}\NWlink{nuweb16a}{, 16a}\NWlink{nuweb17a}{, 17a}.
\end{list}
\end{flushleft}
%------------------------------------------------------------------
...
\protect\makebox[0ex][r]{\NWtarget{nuweb17h}{\rule{0ex}{0ex}}\hspace{1em}}$\langle\,$Affine transformations of $n$ points\nobreak\ {\footnotesize 17h}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\protect\makebox[0ex][r]{\NWtarget{nuweb18}{\rule{0ex}{0ex}}\hspace{1em}}$\langle\,$Symbolic utility to represent points as strings\nobreak\ {\footnotesize 18}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
