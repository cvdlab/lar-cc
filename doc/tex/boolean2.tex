...
\mbox{}\verb@@\hbox{$\langle\,$Import the module\nobreak\ ({\footnotesize \NWtarget{nuweb15d}{15d}\label{scrap29}
 }\mbox{}\verb@myfont@ ) {\footnotesize \NWlink{nuweb18g}{18g}}$\,\rangle$}\verb@@\\
...
\protect\makebox[0ex][r]{\NWtarget{nuweb16c}{\rule{0ex}{0ex}}\hspace{1em}}\verb@"test/py/boolean2/test06.py"@\nobreak\ {\footnotesize 16c }$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@""" test program for the boolean module """@\\
\mbox{}\verb@@\hbox{$\langle\,$Initial import of modules\nobreak\ {\footnotesize \NWlink{nuweb18a}{18a}}$\,\rangle$}\verb@@\\
...
\protect\makebox[0ex][r]{\NWtarget{nuweb17a}{\rule{0ex}{0ex}}\hspace{1em}}\verb@"test/py/boolean2/test03.py"@\nobreak\ {\footnotesize 17a }$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@""" test example with general LAR cells for the boolean module """@\\
\mbox{}\verb@@\hbox{$\langle\,$Initial import of modules\nobreak\ {\footnotesize \NWlink{nuweb18a}{18a}}$\,\rangle$}\verb@@\\
\mbox{}\verb@@\hbox{$\langle\,$Import the module\nobreak\ ({\footnotesize \NWtarget{nuweb17b}{17b}\label{scrap38}
 }\mbox{}\verb@boolean2@ ) {\footnotesize \NWlink{nuweb18g}{18g}}$\,\rangle$}\verb@@\\
...
\protect\makebox[0ex][r]{\NWtarget{nuweb17c}{\rule{0ex}{0ex}}\hspace{1em}}$\langle\,$Visualization of a subset of cells\nobreak\ {\footnotesize 17c}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\protect\makebox[0ex][r]{\NWtarget{nuweb17d}{\rule{0ex}{0ex}}\hspace{1em}}$\langle\,$Visualization of first Boolean step\nobreak\ {\footnotesize 17d}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\mbox{}\verb@@\hbox{$\langle\,$Import the module\nobreak\ ({\footnotesize \NWtarget{nuweb18b}{18b}\label{scrap42}
 }\mbox{}\verb@lar2psm@ ) {\footnotesize \NWlink{nuweb18g}{18g}}$\,\rangle$}\verb@@\\
\mbox{}\verb@@\hbox{$\langle\,$Import the module\nobreak\ ({\footnotesize \NWtarget{nuweb18c}{18c}\label{scrap43}
 }\mbox{}\verb@simplexn@ ) {\footnotesize \NWlink{nuweb18g}{18g}}$\,\rangle$}\verb@@\\
\mbox{}\verb@@\hbox{$\langle\,$Import the module\nobreak\ ({\footnotesize \NWtarget{nuweb18d}{18d}\label{scrap44}
 }\mbox{}\verb@larcc@ ) {\footnotesize \NWlink{nuweb18g}{18g}}$\,\rangle$}\verb@@\\
\mbox{}\verb@@\hbox{$\langle\,$Import the module\nobreak\ ({\footnotesize \NWtarget{nuweb18e}{18e}\label{scrap45}
 }\mbox{}\verb@largrid@ ) {\footnotesize \NWlink{nuweb18g}{18g}}$\,\rangle$}\verb@@\\
\mbox{}\verb@@\hbox{$\langle\,$Import the module\nobreak\ ({\footnotesize \NWtarget{nuweb18f}{18f}\label{scrap46}
 }\mbox{}\verb@myfont@ ) {\footnotesize \NWlink{nuweb18g}{18g}}$\,\rangle$}\verb@@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1ex}
...
\protect\makebox[0ex][r]{\NWtarget{nuweb18h}{\rule{0ex}{0ex}}\hspace{1em}}$\langle\,$Affine transformations of $d$-points\nobreak\ {\footnotesize 18h}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
