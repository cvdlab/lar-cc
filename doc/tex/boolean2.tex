...
\mbox{}\verb@@\hbox{$\langle\,$Import the module\nobreak\ ({\footnotesize 5c\label{scrap9}
 }\mbox{}\verb@boolean2@ ) {\footnotesize \NWlink{nuweb18h}{18h}}$\,\rangle$}\verb@@\\
...
$\langle\,$Triangulation of random points\nobreak\ {\footnotesize \NWtarget{nuweb14b}{14b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\mbox{}\verb@@\hbox{$\langle\,$Import the module\nobreak\ ({\footnotesize 15c\label{scrap28}
 }\mbox{}\verb@lar2psm@ ) {\footnotesize \NWlink{nuweb18h}{18h}}$\,\rangle$}\verb@@\\
\mbox{}\verb@@\hbox{$\langle\,$Import the module\nobreak\ ({\footnotesize 15d\label{scrap29}
 }\mbox{}\verb@myfont@ ) {\footnotesize \NWlink{nuweb18h}{18h}}$\,\rangle$}\verb@@\\
...
\verb@"test/py/boolean2/test05.py"@\nobreak\ {\footnotesize \NWtarget{nuweb15e}{15e} }$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\verb@"test/py/boolean2/test06.py"@\nobreak\ {\footnotesize \NWtarget{nuweb16c}{16c} }$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@""" test program for the boolean module """@\\
\mbox{}\verb@@\hbox{$\langle\,$Initial import of modules\nobreak\ {\footnotesize \NWlink{nuweb18a}{18a}}$\,\rangle$}\verb@@\\
...
$\langle\,$Visualization of a subset of cells\nobreak\ {\footnotesize \NWtarget{nuweb17c}{17c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
$\langle\,$Visualization of first Boolean step\nobreak\ {\footnotesize \NWtarget{nuweb17d}{17d}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\footnotesize\addtolength{\baselineskip}{-1ex}
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb15a}{15a}\NWlink{nuweb15e}{e}\NWlink{nuweb16a}{, 16a}\NWlink{nuweb16c}{c}\NWlink{nuweb17a}{, 17a}.
\end{list}
\end{flushleft}
%------------------------------------------------------------------
...
\mbox{}\verb@@\hbox{$\langle\,$Import the module\nobreak\ ({\footnotesize 18c\label{scrap43}
 }\mbox{}\verb@simplexn@ ) {\footnotesize \NWlink{nuweb18h}{18h}}$\,\rangle$}\verb@@\\
\mbox{}\verb@@\hbox{$\langle\,$Import the module\nobreak\ ({\footnotesize 18d\label{scrap44}
 }\mbox{}\verb@larcc@ ) {\footnotesize \NWlink{nuweb18h}{18h}}$\,\rangle$}\verb@@\\
\mbox{}\verb@@\hbox{$\langle\,$Import the module\nobreak\ ({\footnotesize 18e\label{scrap45}
 }\mbox{}\verb@largrid@ ) {\footnotesize \NWlink{nuweb18h}{18h}}$\,\rangle$}\verb@@\\
\mbox{}\verb@@\hbox{$\langle\,$Import the module\nobreak\ ({\footnotesize 18f\label{scrap46}
 }\mbox{}\verb@myfont@ ) {\footnotesize \NWlink{nuweb18h}{18h}}$\,\rangle$}\verb@@\\
\mbox{}\verb@@\hbox{$\langle\,$Import the module\nobreak\ ({\footnotesize 18g\label{scrap47}
 }\mbox{}\verb@mapper@ ) {\footnotesize \NWlink{nuweb18h}{18h}}$\,\rangle$}\verb@@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1ex}
\footnotesize\addtolength{\baselineskip}{-1ex}
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb5b}{5b}\NWlink{nuweb13a}{, 13a}\NWlink{nuweb15a}{, 15a}\NWlink{nuweb15e}{e}\NWlink{nuweb16a}{, 16a}\NWlink{nuweb16c}{c}\NWlink{nuweb17a}{, 17a}.
\end{list}
\end{flushleft}
%------------------------------------------------------------------
...
$\langle\,$Import the module\nobreak\ {\footnotesize \NWtarget{nuweb18h}{18h}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\footnotesize\addtolength{\baselineskip}{-1ex}
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb5b}{5b}\NWlink{nuweb15a}{, 15a}\NWlink{nuweb15e}{e}\NWlink{nuweb16a}{, 16a}\NWlink{nuweb17a}{, 17a}\NWlink{nuweb18a}{, 18a}.
\end{list}
\end{flushleft}
%------------------------------------------------------------------
...
$\langle\,$Affine transformations of $d$-points\nobreak\ {\footnotesize \NWtarget{nuweb18i}{18i}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
