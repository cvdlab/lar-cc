...
\mbox{}\verb@        if len(model)==2: V,FV = model@\\
\mbox{}\verb@        elif len(model)==3: V,FV,EV = model@\\
...
\protect\makebox[0ex][r]{\NWtarget{nuweb6c}{\rule{0ex}{0ex}}\hspace{1em}}\verb@"larlib/larlib/lar2psm.py"@\nobreak\ {\footnotesize 6c }$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\protect\makebox[0ex][r]{\NWtarget{nuweb8}{\rule{0ex}{0ex}}\hspace{1em}}$\langle\,$Drawing numbers of cells\nobreak\ {\footnotesize 8}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@""" Drawing numbers of cells """@\\
\mbox{}\verb@def cellNumbering (larModel,hpcModel):@\\
\mbox{}\verb@   V,CV = larModel@\\
\mbox{}\verb@   def cellNumbering0 (cellSubset,color=WHITE,scalingFactor=1):@\\
\mbox{}\verb@      text = TEXTWITHATTRIBUTES (TEXTALIGNMENT='centre', TEXTANGLE=0, @\\
\mbox{}\verb@                     TEXTWIDTH=0.1*scalingFactor, @\\
\mbox{}\verb@                     TEXTHEIGHT=0.2*scalingFactor, @\\
\mbox{}\verb@                     TEXTSPACING=0.025*scalingFactor)@\\
\mbox{}\verb@      hpcList = [hpcModel]@\\
\mbox{}\verb@      for cell in cellSubset:@\\
\mbox{}\verb@         point = CCOMB([V[v] for v in CV[cell]])@\\
\mbox{}\verb@         hpcList.append(T([1,2,3])(point)(COLOR(color)(text(str(cell)))))@\\
\mbox{}\verb@      return STRUCT(hpcList)@\\
\mbox{}\verb@   return cellNumbering0@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1ex}
\footnotesize\addtolength{\baselineskip}{-1ex}
