...
\verb@"test/py/lar2psm-tests.py"@\nobreak\ {\footnotesize \NWtarget{nuweb2c}{2c} }$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\verb@"test/py/lar2psm/test-ccomb.py"@\nobreak\ {\footnotesize \NWtarget{nuweb3a}{3a} }$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\verb@"test/py/lar2psm/test-models.py"@\nobreak\ {\footnotesize \NWtarget{nuweb4c}{4c} }$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\hbox{$\langle\,$Import the module\nobreak\ ({\footnotesize 4d\label{scrap11}
 }\mbox{}\verb@lar2psm@ ) {\footnotesize \NWlink{nuweb5b}{5b}}$\,\rangle$}\verb@@\\
...
\footnotesize\addtolength{\baselineskip}{-1ex}
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb3a}{3a}\NWlink{nuweb4c}{, 4c}\NWlink{nuweb6a}{, 6a}\NWlink{nuweb6c}{c}.
\end{list}
\end{minipage}\\[4ex]
\end{flushleft}
%------------------------------------------------------------------
...
\mbox{}\verb@   @\hbox{$\langle\,$Import the module\nobreak\ ({\footnotesize 6b\label{scrap15}
...
\verb@"lib/py/lar2psm.py"@\nobreak\ {\footnotesize \NWtarget{nuweb6c}{6c} }$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@"""Module with functions needed to interface LAR with pyplasm"""@\\
\mbox{}\verb@@\hbox{$\langle\,$Import the module\nobreak\ ({\footnotesize 6d\label{scrap17}
 }\mbox{}\verb@simplexn@ ) {\footnotesize \NWlink{nuweb5b}{5b}}$\,\rangle$}\verb@@\\
