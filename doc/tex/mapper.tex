...
\protect\makebox[0ex][r]{\NWtarget{nuweb22a}{\rule{0ex}{0ex}}\hspace{1em}}\verb@"test/py/mapper/test09.py"@\nobreak\ {\footnotesize 22a }$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@""" Transformation of Struct object to LAR model pair """@\\
...
\mbox{}\verb@@\\
\mbox{}\verb@@\hbox{$\langle\,$Transform Struct object to LAR model pair\nobreak\ {\footnotesize \NWlink{nuweb22b}{22b}}$\,\rangle$}\verb@@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-2ex}
\end{flushleft}
...
\protect\makebox[0ex][r]{\NWtarget{nuweb22b}{\rule{0ex}{0ex}}\hspace{1em}}$\langle\,$Transform Struct object to LAR model pair\nobreak\ {\footnotesize 22b}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@""" Generation of Struct object and transform to LAR model pair """@\\
\mbox{}\verb@cubes = larCuboids([10,10,10],True)@\\
\mbox{}\verb@V = cubes[0]@\\
\mbox{}\verb@FV = cubes[1][-2]@\\
\mbox{}\verb@CV = cubes[1][-1]@\\
\mbox{}\verb@bcells = boundaryCells(CV,FV)@\\
\mbox{}\verb@BV = [FV[f] for f in bcells]@\\
\mbox{}\verb@VIEW(EXPLODE(1.2,1.2,1.2)(MKPOLS((V,BV))))@\\
\mbox{}\verb@@\\
\mbox{}\verb@block = Model((V,BV))@\\
\mbox{}\verb@struct = Struct(10*[block, t(10,0,0)])@\\
\mbox{}\verb@struct = Struct(10*[struct, t(0,10,0)])@\\
\mbox{}\verb@struct = Struct(3*[struct, t(0,0,10)])@\\
\mbox{}\verb@W,FW = struct2lar(struct)@\\
\mbox{}\verb@@\\
\mbox{}\verb@VIEW(EXPLODE(1.2,1.2,1.2)(MKPOLS((W,FW))))@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1ex}
\footnotesize\addtolength{\baselineskip}{-1ex}
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb22a}{22a}\NWlink{nuweb23a}{, 23a}.
\end{list}
\end{flushleft}
%-------------------------------------------------------------------------------
...
\protect\makebox[0ex][r]{\NWtarget{nuweb23a}{\rule{0ex}{0ex}}\hspace{1em}}\verb@"test/py/mapper/test10.py"@\nobreak\ {\footnotesize 23a }$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@""" Remove double instances of cells (and the unused vertices) """@\\
\mbox{}\verb@import sys@\\
\mbox{}\verb@""" import modules from larcc/lib """@\\
\mbox{}\verb@sys.path.insert(0, 'lib/py/')@\\
\mbox{}\verb@from larcc import *@\\
...
\mbox{}\verb@@\\
\mbox{}\verb@@\hbox{$\langle\,$Transform Struct object to LAR model pair\nobreak\ {\footnotesize \NWlink{nuweb22b}{22b}}$\,\rangle$}\verb@@\\
\mbox{}\verb@@\hbox{$\langle\,$Remove the double instances of cells\nobreak\ {\footnotesize \NWlink{nuweb23b}{23b}}$\,\rangle$}\verb@@\\
\mbox{}\verb@VIEW(EXPLODE(1.2,1.2,1.2)(MKPOLS((W,FW))))@\\
\mbox{}\verb@@\\
\mbox{}\verb@@\hbox{$\langle\,$Remove the unused vertices\nobreak\ {\footnotesize \NWlink{nuweb23c}{23c}}$\,\rangle$}\verb@@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-2ex}
\end{flushleft}
...
\protect\makebox[0ex][r]{\NWtarget{nuweb23b}{\rule{0ex}{0ex}}\hspace{1em}}$\langle\,$Remove the double instances of cells\nobreak\ {\footnotesize 23b}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@""" Remove the double instances of cells """@\\
\mbox{}\verb@cellDict = defaultdict(list)@\\
\mbox{}\verb@for k,cell in enumerate(FW):@\\
\mbox{}\verb@   cellDict[tuple(cell)] += [k]@\\
\mbox{}\verb@FW = [list(key) for key in cellDict.keys() if len(cellDict[key])==1]@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1ex}
\footnotesize\addtolength{\baselineskip}{-1ex}
...
\protect\makebox[0ex][r]{\NWtarget{nuweb23c}{\rule{0ex}{0ex}}\hspace{1em}}$\langle\,$Remove the unused vertices\nobreak\ {\footnotesize 23c}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@""" Remove the unused vertices """@\\
\mbox{}\verb@print "len(W) =",len(W)@\\
\mbox{}\verb@V,FV = larRemoveVertices(W,FW)@\\
\mbox{}\verb@print "len(V) =",len(V)@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1ex}
\footnotesize\addtolength{\baselineskip}{-1ex}
...
\protect\makebox[0ex][r]{\NWtarget{nuweb24a}{\rule{0ex}{0ex}}\hspace{1em}}$\langle\,$Remove the unused vertices from a LAR model pair\nobreak\ {\footnotesize 24a}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@""" Remove the unused vertices """@\\
\mbox{}\verb@def larRemoveVertices(V,FV):@\\
\mbox{}\verb@   vertDict = dict()@\\
\mbox{}\verb@   index,defaultValue,FW,W = -1,-1,[],[]@\\
\mbox{}\verb@      @\\
...
\mbox{}\verb@      FW += [outcell]@\\
\mbox{}\verb@   return W,FW@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1ex}
\footnotesize\addtolength{\baselineskip}{-1ex}
...
\protect\makebox[0ex][r]{\NWtarget{nuweb24b}{\rule{0ex}{0ex}}\hspace{1em}}\verb@"lib/py/mapper.py"@\nobreak\ {\footnotesize 24b }$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\protect\makebox[0ex][r]{\NWtarget{nuweb25a}{\rule{0ex}{0ex}}\hspace{1em}}\verb@"test/py/mapper/test02.py"@\nobreak\ {\footnotesize 25a }$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\protect\makebox[0ex][r]{\NWtarget{nuweb25b}{\rule{0ex}{0ex}}\hspace{1em}}\verb@"test/py/mapper/test03.py"@\nobreak\ {\footnotesize 25b }$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\protect\makebox[0ex][r]{\NWtarget{nuweb26a}{\rule{0ex}{0ex}}\hspace{1em}}$\langle\,$Basic tests of mapper module\nobreak\ {\footnotesize 26a}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\protect\makebox[0ex][r]{\NWtarget{nuweb26b}{\rule{0ex}{0ex}}\hspace{1em}}\verb@"test/py/mapper/test01.py"@\nobreak\ {\footnotesize 26b }$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\protect\makebox[0ex][r]{\NWtarget{nuweb27}{\rule{0ex}{0ex}}\hspace{1em}}$\langle\,$Model limits\nobreak\ {\footnotesize 27}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\protect\makebox[0ex][r]{\NWtarget{nuweb28a}{\rule{0ex}{0ex}}\hspace{1em}}$\langle\,$Alignment primitive\nobreak\ {\footnotesize 28a}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\protect\makebox[0ex][r]{\NWtarget{nuweb28b}{\rule{0ex}{0ex}}\hspace{1em}}$\langle\,$Initial import of modules\nobreak\ {\footnotesize 28b}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@from pyplasm import *@\\
...
\footnotesize\addtolength{\baselineskip}{-1ex}
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb20a}{20a}\NWlink{nuweb20b}{b}\NWlink{nuweb21a}{, 21a}\NWlink{nuweb21c}{c}\NWlink{nuweb24b}{, 24b}\NWlink{nuweb25a}{, 25a}\NWlink{nuweb25b}{b}\NWlink{nuweb26b}{, 26b}.
\end{list}
\end{flushleft}
%-------------------------------------------------------------------------------
...
\protect\makebox[0ex][r]{\NWtarget{nuweb28c}{\rule{0ex}{0ex}}\hspace{1em}}$\langle\,$Affine transformations of $d$-points\nobreak\ {\footnotesize 28c}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\protect\makebox[0ex][r]{\NWtarget{nuweb29}{\rule{0ex}{0ex}}\hspace{1em}}$\langle\,$Symbolic utility to represent points as strings\nobreak\ {\footnotesize 29}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
