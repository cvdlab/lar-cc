...
\mbox{}\verb@      V = AA(CONS(coordFuncs))(V)  # plasm CONStruction@\\
\mbox{}\verb@      return [V,CV]@\\
\mbox{}\verb@      # checkModel([V,CV],dim)  TODO@\\
...
$\langle\,$Traversal of a scene multigraph\nobreak\ {\footnotesize \NWtarget{nuweb17a}{17a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
$\langle\,$Structure traversal algorithm\nobreak\ {\footnotesize \NWtarget{nuweb17b}{17b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\verb@"test/py/mapper/test06.py"@\nobreak\ {\footnotesize \NWtarget{nuweb18c}{18c} }$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
