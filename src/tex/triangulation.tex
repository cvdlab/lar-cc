...
A color visualization of the 2-cells of the previous cellular complex is produced by the \texttt{test09.py} file.
%-------------------------------------------------------------------------------
...
When reconstructing the containment lattice of component cycles of a boundary chain the strategy of testing a single vertex of cycle for containment does not work, since the tested vertex might stay in non-manifold position, so that---even if internal points stay either internal or external to the target cycle, the result of the containment test would be of type \texttt{.on.}, corresponding of test point on the boundary of the target cycle, so producing a wrong containment lattice.
