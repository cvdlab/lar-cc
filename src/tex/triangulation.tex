...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   ...
   (a) numbering of cycles of a 2-complex with a hole in a 2-cell; (b) color display of 2-cells; (c) boundary of the 2-chain $\{f_0, f_1, f_2\}$, codified in coordinates as \texttt{[1,1,1,0]}. 
