...
def print_struct(out, obj, parent_id):
	tvect = obj.box[0]
	V,boundaryEdges = structBoundaryModel(obj)
	coordinates = boundaryModel2polylines((V,boundaryEdges))
...
def printStruct2GeoJson(path, struct):
	...
	V,boundaryEdges = structBoundaryModel(struct)   #+new
	boundaryPolygons = boundaryModel2polylines((V,boundaryEdges))  #+new
...
printStruct2GeoJson("test/json/tower/",torre)
